...
[![Latest release](https://img.shields.io/badge/latest%20release-v1.1.0-2f5fd0)](https://github.com/pooryam92/daily/releases/latest)
...
| ----------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------- |
| Windows           | [Daily-Setup-1.1.0.exe](https://github.com/pooryam92/daily/releases/download/v1.1.0/Daily-Setup-1.1.0.exe)   | By itself                         |
...
1. Run `Daily-Setup-1.1.0.exe`. The browser may warn about the download first ("isn't commonly
...
1. Take `Daily-1.1.0-arm64.dmg` for a Mac with Apple silicon (M1 and later), `Daily-1.1.0-x64.dmg`
...
- **`.deb`.**
  ...
  ```sh
  sudo apt install ./daily_1.1.0_amd64.deb
  ```

- **`.rpm`.** The package is not signed, which zypper asks about.

  ```sh
  sudo dnf install ./daily-1.1.0.x86_64.rpm      # Fedora
