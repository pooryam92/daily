...
[![Latest release](https://img.shields.io/badge/latest%20release-v1.2.0-2f5fd0)](https://github.com/pooryam92/daily/releases/latest)
...
| ----------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------- |
| Windows           | [Daily-Setup-1.2.0.exe](https://github.com/pooryam92/daily/releases/download/v1.2.0/Daily-Setup-1.2.0.exe)   | By itself                         |
| macOS, Apple chip | [Daily-1.2.0-arm64.dmg](https://github.com/pooryam92/daily/releases/download/v1.2.0/Daily-1.2.0-arm64.dmg)   | The app tells you; you install it |
| macOS, Intel chip | [Daily-1.2.0-x64.dmg](https://github.com/pooryam92/daily/releases/download/v1.2.0/Daily-1.2.0-x64.dmg)       | The app tells you; you install it |
| Any Linux         | [Daily-1.2.0.AppImage](https://github.com/pooryam92/daily/releases/download/v1.2.0/Daily-1.2.0.AppImage)     | By itself                         |
| Debian, Ubuntu    | [daily_1.2.0_amd64.deb](https://github.com/pooryam92/daily/releases/download/v1.2.0/daily_1.2.0_amd64.deb)   | By itself, after your password    |
| Fedora, openSUSE  | [daily-1.2.0.x86_64.rpm](https://github.com/pooryam92/daily/releases/download/v1.2.0/daily-1.2.0.x86_64.rpm) | By itself, after your password    |
...
1. Run `Daily-Setup-1.2.0.exe`. The browser may warn about the download first ("isn't commonly
...
1. Take `Daily-1.2.0-arm64.dmg` for a Mac with Apple silicon (M1 and later), `Daily-1.2.0-x64.dmg`
...
- **`.deb`.**
  ...
  ```sh
  sudo apt install ./daily_1.2.0_amd64.deb
  ```

- **`.rpm`.** The package is not signed, which zypper asks about.

  ```sh
  sudo dnf install ./daily-1.2.0.x86_64.rpm      # Fedora
  sudo zypper install ./daily-1.2.0.x86_64.rpm   # openSUSE
  ```
